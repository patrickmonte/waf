...
# Script para instalar o ModSecurity v2 com GeoIP em Oracle Linux 7, 8 ou 9
# Versão simplificada sem suporte a CRS
...
# --- Finalização ---
echo "---------------------------------------------------------"
echo "🚀 Instalação e configuração do ModSecurity v2 com GeoIP concluídas!"
echo "---------------------------------------------------------"